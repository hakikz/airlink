    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">AWB Form</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="card card-default">
            <!-- form -->
            <form action="{{ route('backend.awb.store') }}" id="sales_info" method="POST">
              @csrf
              <div class="card-header">
                <h3 class="card-title">Air Way Bill Form</h3>
                    ...
                    <div class="row">
                      <div class="col-md-6"> 
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('awb_num') is-invalid @enderror" name="awb_num" placeholder="Example: AWB12365789" value="{{ old('awb_num') }}">
                          @error('awb_num')
                      ...
                      <div class="col-md-6"> 
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('storage_size') is-invalid @enderror" name="storage_size" placeholder="Example: 45" value="{{ old('storage_size') }}">
                          @error('storage_size')
