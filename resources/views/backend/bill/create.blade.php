                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                @error('qty_cartoon')
                                  <div class="invalid-feedback">{{ $errors->first('qty_cartoon') }}</div>
                                @enderror
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                  <input type="number" name="weight" id="product_weight" class="form-control @error('weight') is-invalid @enderror"
                                    aria-label="Weight" aria-describedby="basic-addon2" min="0"
