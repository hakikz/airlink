        ...
        <div class="content">
          <div class="container-fluid">
            <div class="card card-default">
              <!-- form -->
              <form action="{{ route('backend.branch.store') }}" id="sales_info" method="POST">
                @csrf
                  ...
                  <div class="row">
                    <div class="col-md-6 offset-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Branch Name (Example: Bangladesh)" value="{{ old('name') }}">
                        @error('name')
