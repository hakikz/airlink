        ...
        <div class="content">
          <div class="container-fluid">
            <div class="card card-default">
              <!-- form -->
              <form action="{{ route('backend.product.update', $product->id) }}" id="sales_info" method="POST">
                @csrf
                @method('PUT')
                  ...
                  <div class="row">
                    <div class="col-md-6 offset-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Product Name (Example: Fan)" value="{{ $product->name }}">
                        @error('name')
